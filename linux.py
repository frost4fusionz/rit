...
TELEGRAM_BOT_TOKEN = '7151529676:AAED9GJZKQy3kVZCy6xUbYqAlKRggfZ2Uto'
ADMIN_USER_IDS = {6240348610, 7383077317, 6188354219, 1066744659}
...
def log_command(user_id, name, target, port, duration):
    with open(LOG_FILE, 'a') as f:
        f.write(f"UserID: {user_id} | Name: {name} | Target: {target} | Port: {port} | Duration: {duration} | Timestamp: {datetime.datetime.now()}\n")
...
async def attack(update: Update, context: CallbackContext):
    ...
    log_command(user_id, user_name, ip, port, duration)
...
def main():
    ...
    print("Bot is running...")  # Bot running indicator
